...
RUN cd $APP_DIR; gem install bundler --version 2.2.15; bundle config deployment production; bundle config without development test; bundle config build.nokogiri --use-system-libraries; gem install pkg-config
